...
//
// generate: default true (opt-out) - unlike every other artifact in this project, which
...
// already implies, not an opt-in feature.
//
// targetPackage: null only when generate is false - non-null and validated eagerly at yml load
...
public record ExceptionHandlerConfig(boolean generate, String targetPackage, String className) {
}
